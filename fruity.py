...
if torch.cuda.is_available():
    model.load_state_dict(torch.load('./models/fruity_image_model_baru_lagi.pth'))
    model = model.to(device)
else:
    model.load_state_dict(torch.load('./models/fruity_image_model_baru_lagi.pth',map_location=torch.device('cpu')))
